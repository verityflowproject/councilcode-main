  ...
  return (
    <main style={{ background: 'var(--bg-base)', minHeight: '100vh' }}>
      ...
      >
        ...
        >
          How VerityFlow collects, uses, and protects your data.
        </p>
        <Link
          href="/"
          style={{
      ...
      >
        ...
        >
          ...
          >
            Our full Privacy Policy is being drafted and will be published here shortly. In the meantime, here is what you should know:
          </p>
          <ul
            style={{
              listStyle: 'none',
          ...
          >
            {[
              'Your code and project data are never shared with other users and are never used to train AI models.',
              'API keys are encrypted at rest with AES-256-GCM. They are never logged or returned in plaintext.',
              'We collect your email and account information to provide the service. We do not sell it.',
